...
namespace ShowMapConstruktor
{
    internal class CMusicShowList
    {
        ...
        public void AddShow(string cityName, string misucShowName, string nameMisucPlace, string misucGroup, string dateMisucPlace, int musicIndex, string typeMusicShowOrOriginOrGenresOfMusic, bool isBalletorForNigth)
        {
            switch (musicIndex)
            {
                
                case 2:
                    musicShow.Add(new CRockConcert(cityName, misucShowName, nameMisucPlace, misucGroup, dateMisucPlace, typeMusicShowOrOriginOrGenresOfMusic, isBalletorForNigth)); 
                    break;
                case 1:
                    musicShow.Add(new CBalletOpera(cityName, misucShowName, nameMisucPlace, misucGroup, dateMisucPlace, isBalletorForNigth, typeMusicShowOrOriginOrGenresOfMusic));
                    break;
                case 0:
                    musicShow.Add(new CDefaultMusicShow(cityName, misucShowName, nameMisucPlace,  misucGroup, dateMisucPlace, typeMusicShowOrOriginOrGenresOfMusic));
                    break;
